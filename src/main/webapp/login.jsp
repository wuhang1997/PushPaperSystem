...
<body>
	...
	<div class="cent-box">
		<div class="cent-box-header">
			<h1 class="main-title hide">知---乎</h1>
		...
		<div class="cont-main clearfix">
			<div class="index-tab">
				<div class="index-slide-nav">
					<a href="${pageContext.request.contextPath }/login.jsp" class="active">登录</a> <a href="${pageContext.request.contextPath }/register.jsp">注册</a>
